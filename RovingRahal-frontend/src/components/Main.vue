                ...
                <ul class="flex flex-wrap -mb-px text-sm font-medium justify-center" id="myTab"
                    ...
                    <li class="mr-2" role="presentation">
                        <button
                            ...
                            id="Folowing-tab" data-tabs-target="#Folowing" type="button" role="tab"
                            aria-controls="Folowing" aria-selected="false">Following</button>
                    </li>
                </ul>
            </div>
            <div id="myTabContent">
                <div class="hidden" id="All" aria-labelledby="profile-tab">
                    <div class="posts all flex px-4 mt-5">
